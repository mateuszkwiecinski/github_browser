...
object PullRequestDiff : DiffUtil.ItemCallback<PullRequestPreview>() {
    ...
    override fun areItemsTheSame(oldItem: PullRequestPreview, newItem: PullRequestPreview) =
        oldItem.id == newItem.id

    override fun areContentsTheSame(oldItem: PullRequestPreview, newItem: PullRequestPreview) =
        oldItem == newItem
}
